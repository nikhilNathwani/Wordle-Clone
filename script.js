...
function flipTile(tile, index, array, guess, matchPattern) {
	...
	tile.addEventListener(
		...
		() => {
			...
			} else if (matchPattern[index] == LetterState.MISPLACED) {
...
function getMatchPattern(guess) {
	var matchPattern = Array(targetWord.length).fill(LetterState.WRONG);
	var targetWordLetterFreqMap = [...targetWord].reduce(
		(counts, char) => ((counts[char] = (counts[char] || 0) + 1), counts),
		{}
	);
